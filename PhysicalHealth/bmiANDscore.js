exports.calculateBmiAndScore = function calculateBmiAndScore(weight, height, weightUnit = 'kg', heightUnit = 'cm', inches = 0) {
    ...
    if ((weightUnit === 'kg' && (weight < 1 || weight > 300)) || (weightUnit === 'lbs' && (weight < 2.2 || weight > 661))) {
        throw new Error("Invalid weight. Weight must be between 1kg and 300kg, or between 2.2lbs and 661lbs.");
    }

    // Check for reasonable height values
    if ((heightUnit === 'cm' && (height < 50 || height > 250)) || (heightUnit === 'm' && (height < 0.5 || height > 2.5)) || (heightUnit === 'ft' && (height < 1.6 || height > 8.2))) {
        throw new Error("Invalid height. Height must be between 50cm and 250cm, between 0.5m and 2.5m, or between 1.6ft and 8.2ft.");
    }
