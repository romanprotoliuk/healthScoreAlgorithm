exports.calculateBloodPressureScore = function calculateBloodPressureScore(systolic, diastolic) {
    // Validation
    if (systolic === undefined || diastolic === undefined) {
        throw new Error("Both systolic and diastolic blood pressure values must be provided.");
    }
    if (typeof systolic !== 'number' || typeof diastolic !== 'number') {
        throw new Error("Blood pressure values must be numeric.");
    }
    if (systolic < 40 || systolic > 300 || diastolic < 40 || diastolic > 300) {
        throw new Error("Blood pressure values are out of a reasonable physiological range.");
    }
