...
const { calculateBloodPressureScore } = require("./CardiovascularAndMetabolicHealth/bloodPressureScore");
...
const { calculateDietaryHabitsScore } = require("./LifestyleAndHabits/DietaryHabitsScore")

module.exports.getHealthScore = function getHealthScore(age, gender, weight, height, systolicBP, diastolicBP, smokingStatus, glucoseLevels, alcoholConsumption, activityData, sleepData, dietaryHabitsData, weightUnit = 'kg', heightUnit = 'cm', inches = 0) {
    // Validations
    ...
    if (typeof age !== 'number' || typeof weight !== 'number' || typeof height !== 'number' || typeof systolicBP !== 'number' || typeof diastolicBP !== 'number' || typeof glucoseLevels !== 'number') {
        throw new Error("Age, weight, height, systolicBP, diastolicBP, and glucoseLevels must be numbers.");
    }
